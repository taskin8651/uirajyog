...
@section('page-title', 'Edit Sustainability Section')
...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <p style="font-size:13px; color:#64748B; margin:6px 0 0;">
            Update title, description and image for sustainability page.
        </p>
    </div>
</div>

<form action="{{ route('admin.sustainability-sections.update', $sustainabilitySection->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div style="display:grid; gap:18px;">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="title" 
                        id="title" 
                        value="{{ old('title', $sustainabilitySection->title) }}" 
                        class="field-input"
                    >
                ...
                <div>
                    ...
                    >{{ old('description', $sustainabilitySection->description) }}</textarea>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:18px; align-items:start;">
                    <div>
                        ...
                        <input 
                            ...
                            name="sort_order" 
                            id="sort_order" 
                            value="{{ old('sort_order', $sustainabilitySection->sort_order) }}" 
                            class="field-input"
                        >
                    ...
                    <div style="display:flex; align-items:center; gap:12px; padding-top:24px;">
                        <label style="display:flex; align-items:center; gap:10px; cursor:pointer; font-size:13px; color:#374151;">
                            <input 
                                ...
                                name="status" 
                                value="1" 
                                {{ old('status', $sustainabilitySection->status) ? 'checked' : '' }} 
                                style="width:auto;"
                            >
                            Active
                        </label>
    ...
    <div style="margin-top:20px; display:flex; flex-wrap:wrap; gap:12px;">
        ...
        <a href="{{ route('admin.sustainability-sections.index') }}" class="btn-ghost">
            Cancel
        </a>
    </div>
</form>
...
@if($sustainabilitySection->image)
    <form 
        action="{{ route('admin.sustainability-sections.image.destroy', $sustainabilitySection->id) }}" 
        method="POST" 
