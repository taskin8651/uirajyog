...
@section('page-title', 'Create Sustainability Section')
...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <p style="font-size:13px; color:#64748B; margin:6px 0 0;">
            Add title, description and image for sustainability page.
        </p>
    </div>
</div>

<form action="{{ route('admin.sustainability-sections.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
