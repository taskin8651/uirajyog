...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <h2 style="font-size:22px; font-weight:700; color:#0F172A; margin:10px 0 0;">Add Brand</h2>
        <p style="font-size:13px; color:#64748B; margin:6px 0 0;">Add a new brand with logo, website and display order.</p>
    </div>
</div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div>
                ...
                <p style="font-size:12px;color:#94A3B8;margin:2px 0 0;">Fill in the required brand information.</p>
            </div>
        </div>
        <div class="form-card-body">
            <div style="display:grid; gap:18px;">
                ...
                <div>
                    ...
                    <input type="url" name="website_url" id="website_url" value="{{ old('website_url') }}" class="field-input" placeholder="https://example.com">
