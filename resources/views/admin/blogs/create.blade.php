...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <h2 style="font-size:22px; font-weight:700; color:#0F172A; margin:10px 0 0;">Add Blog</h2>
        <p style="font-size:13px; color:#64748B; margin:6px 0 0;">Create a new frontend blog post.</p>
    </div>
</div>
...
<form action="{{ route('admin.blogs.store') }}" method="POST">
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div>
                ...
                <p style="font-size:12px;color:#94A3B8;margin:2px 0 0;">Title, summary, and full description.</p>
            </div>
        </div>
        ...
        <div class="form-card-body">
            <div style="display:grid; gap:18px;">
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="field-input" required>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:18px; align-items:start;">
                    ...
                    <div style="display:flex; align-items:center; gap:12px; padding-top:24px;">
                        <label style="display:flex; align-items:center; gap:10px; cursor:pointer; font-size:13px; color:#374151;">
                            <input type="checkbox" name="status" value="1" {{ old('status', 1) ? 'checked' : '' }} style="width:auto;">
                            Active
                        </label>
                    </div>
                </div>
    ...
    <div style="margin-top:20px; display:flex; flex-wrap:wrap; gap:12px;">
        <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Save Blog</button>
