...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <h2 style="font-size:22px; font-weight:700; color:#0F172A; margin:10px 0 0;">Add FAQ</h2>
        <p style="font-size:13px; color:#64748B; margin:6px 0 0;">Create a new frequently asked question and answer.</p>
    </div>
</div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div>
                ...
                <p style="font-size:12px;color:#94A3B8;margin:2px 0 0;">Add question and answer for the FAQ.</p>
            </div>
        </div>
        <div class="form-card-body">
            <div style="display:grid; gap:18px;">
                <div>
                    ...
                    <input type="text" name="question" id="question" value="{{ old('question') }}" class="field-input">
                ...
                <div>
                    ...
                    <textarea name="answer" id="answer" class="field-textarea">{{ old('answer') }}</textarea>
