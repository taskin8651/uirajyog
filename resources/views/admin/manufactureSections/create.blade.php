...
@section('page-title', 'Add Manufacture Section')
...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <h2 style="font-size:22px; font-weight:700; color:#0F172A; margin:10px 0 0;">Add Manufacture Section</h2>
        <p style="font-size:13px; color:#64748B; margin:6px 0 0;">Create a new manufacture section with image.</p>
    </div>
</div>

<form action="{{ route('admin.manufacture-sections.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div>
                ...
                <p style="font-size:12px;color:#94A3B8;margin:2px 0 0;">Add title and image for the manufacture section.</p>
            </div>
        </div>
