...
.field-input, .field-textarea { width:100%; padding:11px 14px; border:1.5px solid #E2E8F0; border-radius:9px; font-size:13.5px; color:#1E293B; outline:none; background:#fff; font-family:inherit; }
.field-input:focus, .field-textarea:focus { border-color:var(--accent); box-shadow:0 0 0 3px rgba(79,70,229,.12); }
.field-textarea { min-height:130px; resize:vertical; }
.field-error { font-size:12px; color:#EF4444; margin-top:6px; }
.btn-primary { display:inline-flex; align-items:center; gap:8px; padding:10px 22px; border-radius:10px; background:var(--accent); color:#fff; font-size:13.5px; font-weight:600; border:none; cursor:pointer; }
...
.image-preview { width:100%; max-width:200px; border-radius:12px; margin-top:12px; border:1px solid #E2E8F0; }
</style>
@endsection
...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <p style="font-size:13px; color:#64748B; margin:4px 0 0;">Update the category information below.</p>
    </div>
</div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
                    ...
                    <div style="display:flex; align-items:center; gap:14px; padding-top:24px;">
                        <label style="display:flex; align-items:center; gap:10px; cursor:pointer;">
                            <input type="checkbox" name="status" value="1" {{ old('status', $productCategory->status) ? 'checked' : '' }} style="width:auto; padding:0; height:auto; margin:0; border:none; background:transparent;">
